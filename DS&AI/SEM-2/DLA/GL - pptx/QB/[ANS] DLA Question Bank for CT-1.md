# DLA Question Bank — Answer Sheet (CT-1)
> All questions are 5 marks. Answers emphasise theory, intuition, and explanation first. Formulas are included only where essential, with full symbol-by-symbol expansion.

---

## Q1. Explain the working of Adagrad optimizer with mathematical formulation (5 Marks)
...
## Q2. Explain Feedforward Neural Networks ( #FNN) and the role of #backpropagation using chain rule (5 Marks)
...
## Q3. Explain the Gradient Descent algorithm with mathematical formulation and working steps (5 Marks)

**Answer:**

### What is Gradient Descent?
**Gradient Descent** is the core optimization algorithm used to train neural networks. Its purpose is to **minimize the loss function** — the measure of how wrong the model's predictions are — by iteratively adjusting the model's parameters (weights and biases).
...
## Q4. Discuss the role of activation functions in neural networks and compare any three activation functions (5 Marks)
...
## Q5. Explain the TensorFlow data structures and types of tensors with examples (5 Marks)
...
## Q6. Compare Machine Learning and Deep Learning with suitable examples (5 Marks)
...
## Q7. Discuss Dropout and Early Stopping as regularization techniques (5 Marks)
...
## Q8. Explain the perceptron model with neat diagram and mathematical expression (5 Marks)
...
## Q9. Describe RMSProp optimizer and explain how it overcomes Adagrad limitations (5 Marks)
...
## Q10. Discuss vanishing and exploding gradient problems in deep neural networks (5 Marks)
...
## Q11. Describe Binary Cross-Entropy and Categorical Cross-Entropy loss functions (5 Marks)
...
## Q12. Explain the concepts of underfitting and overfitting. How does learning rate influence model performance? (5 Marks)
...
## Q13. Define Deep Learning. Why is it called "deep"? Explain with architecture details (5 Marks)
...
## Q14. Differentiate Batch Gradient Descent, Stochastic Gradient Descent, and Mini-Batch Gradient Descent (5 Marks)
...
## Q15. Explain any two regularization techniques used in neural networks (5 Marks)
...
## Q16. Explain the role of normalization techniques in improving deep network training (5 Marks)
...
## Q17. Explain the biological motivation of Artificial Neural Networks. Illustrate the mapping between biological neuron and ANN components (5 Marks)
...
## Q18. Describe the Perceptron learning rule. Why can a single perceptron not solve the XOR problem? (5 Marks)
...
## Q19. Describe the Adam optimizer and explain how it combines momentum and RMSProp (5 Marks)
...
## Q20. Explain TensorFlow workflow and its key components (5 Marks)
...
## Q21. Derive the gradient descent update rule and explain the effect of learning rate (5 Marks)
...
## Q22. Discuss the problem of unit saturation in deep neural networks (5 Marks)
...
## Q23. Compare Batch Normalization, Group Normalization, and Instance Normalization (5 Marks)
...
## Q24. Describe Batch Normalization and its advantages in deep learning training (5 Marks)
